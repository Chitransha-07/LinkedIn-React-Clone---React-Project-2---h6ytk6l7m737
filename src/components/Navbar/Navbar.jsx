...
function Navbar() {
  ...
  // Handlers for input focus events
  ...
  // Effect to handle 'Enter' key press in search input
  useEffect(() => {
  ...
  // Effect to handle dark mode change
  useEffect(() => {
    if (darkMode) {
      ...
      <div className="navbar-menu-container">
        <Link to="/feed">
          <div style={{ display: "flex" }} className="main-logo-container">
            <svg
              ...
              fill={`${darkMode ? "rgba(255, 255, 255, 0.9)" : "#0A66C2"}`}
          ...
          >
            <div className={`${isSearchbarStretch ? "stretch-searchbar" : ""}`}>
              <input
                ...
                ref={stretchSearchRef}
                onFocus={handleFocusInInput}
                onBlur={handleFocusOutInput}
                placeholder="Search"
                className={`navbar-search-input ${darkMode ? "dark" : ""} `}
                type="text"
              />
            ...
            <button
              onClick={handleStretchSearchInput}
              className={`navbar-search-button ${
                isSearchbarStretch ? "hide" : ""
              } ${darkMode ? "dark" : ""}`}
            >
              <span>
                <svg
        ...
        <nav>
          <ul className={`navbar-list ${isSearchbarStretch ? "hide" : ""}`}>
            ...
            <li
              style={{ borderRight: "1px solid #D9D9D9", position: "relative" }}
...
// Navbar profile modal component
