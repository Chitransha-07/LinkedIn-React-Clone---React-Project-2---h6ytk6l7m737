        ...
        <div id="app-boot-bg-loader" className="app-boot-bg-skeleton">
            ...
            <div className="content">
                <div className="initial-load-animation">
                    <div className="linkedin-image display-flex justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" className="loader__linkedin-logo" width="190" height="48" viewBox="0 0 190 48">
                            <g>
                                <g>
