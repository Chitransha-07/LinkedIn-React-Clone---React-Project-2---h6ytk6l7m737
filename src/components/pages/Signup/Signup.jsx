  ...
  return isLoggedIn ? (
    ...
    <div>
      <header className="login-signup-header signup-header">
        <Link
          className="login-signup-linkedin-icon-container signup-linkedIn-container"
          to="/"
        >
          ...
          <div className="signup-form-input-container">
            ...
            <div
              className={`signup-text-input ${
                usernameAlert ? "signup-text-input-alret" : ""
              }`}
            >
              <input
                ref={usernameRef}
            ...
            <p>{usernameAlert}</p>
            <label style={{ marginTop: "1rem" }} htmlFor="email">
              Email
            </label>
            <div
              className={`signup-text-input ${
                emailAlert ? "signup-text-input-alret" : ""
              }`}
            >
              <input
                ref={emailRef}
            ...
            <div
              className={`signup-text-input ${
                passwordAlert ? "signup-text-input-alret" : ""
              }`}
            >
              <input
                ref={passwordRef}
